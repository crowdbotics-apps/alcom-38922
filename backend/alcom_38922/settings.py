"""
Django settings for alcom_38922 project.
...
WSGI_APPLICATION = 'alcom_38922.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "alcom_38922 API",
    "DESCRIPTION": "API documentation for alcom_38922 App",
    "VERSION": "v1",
}
